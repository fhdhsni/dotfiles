...
(let ((class '((class color) (min-colors 89)))
      ...
      (magenta-1 "#ff7bbb") (magenta-2 "#ff4ea3") (magenta-3 "#ff1f8b") (magenta-0 "#ffafd7") (magenta-00 "#ffd7ff")
      ...
      (blue-1 "#5fafd7") (blue-2 "#1f5bff") (blue-3 "#005f87") (blue-4 "#o005faf") (blue-5 "#0000af") (blue-6 "#00005f")
      ...
      (black-2-5 "#6c6c6c") (black-3 "#4e4e4e") (black-4 "#3a3a3a") (black-5 "#31363B") (black-6 "#000000")
      ...
      (pouria "#e97680") (pouria-1 "#a4cf80") (pouria-2 "#91b0cf"))
  ...
  (custom-theme-set-faces
   ...
   `(default ((((class color) (min-colors 4096))
               (:foreground ,white-1 :background "#181A26"))
              (((class color) (min-colors 256))
               (:foreground ,white-1 :background ,black-5))
              (,class
               (:foreground ,white-1 :background ,black-5))))
   `(cursor ((,class (:background "hot pink"))))
   ;; Highlighting faces
   ...
   `(hl-line ((,class (:background "#331E3B"))))
   `(highlight-symbol-face ((,class (:background "#103050"))))
   ...
   `(region ((,class (:foreground ,orange-2 :background ,black-5))))
   ...
   ;; minibuffer-line
   `(minibuffer-line ((,class (:background nil :inherit nil))))

   ;; buffer-menue
   `(buffer-menu-buffer ((,class (:bold nil))))

   ;; Font lock faces
   `(font-lock-builtin-face ((,class (:foreground ,purple-1))))
   `(font-lock-comment-delimiter-face ((,class (:foreground ,black-2-5 :slant italic))))
   `(font-lock-comment-face ((,class (:foreground ,black-1 :slant italic))))
   ...
   `(font-lock-function-name-face ((,class (:foreground ,pouria))))
   `(font-lock-keyword-face ((,class (:foreground ,pouria-2))))
   ...
   `(font-lock-string-face ((,class (:foreground ,pouria-1 :slant italic))))
   `(font-lock-type-face ((,class (:foreground ,cyan-3))))
   `(font-lock-variable-name-face ((,class (:foreground "#c6c6c6"))))
   ...
   `(org-checkbox ((,class (:foreground ,white-2))))
   `(org-date ((,class (:foreground ,blue-0 :underline t))))
   `(org-done ((,class ( :foreground ,green-3))))
   `(org-todo ((,class ( :foreground ,red-00))))
   ...
   `(org-tag ((,class (:foreground ,white-1  :weight book))))
   ...
   `(org-special-keyword ((,class (:foreground ,magenta-0))))
   ...
   `(org-code ((,class (:foreground ,blue-1))))
   ...
   `(org-block ((,class (:foreground ,blue-1))))
   `(org-block-background ((,class (:foreground nil))))
   `(org-block-begin-line ((,class (:foreground ,black-3))))
   `(org-block-end-line ((,class (:foreground ,black-3))))
   ...
   `(org-verbatim ((,class (:foreground ,blue-1))))
   ...
   `(rainbow-delimiters-depth-1-face
     ((,class (:inherit rainbow-delimiters-base-face :foreground ,purple-1))))

   `(rainbow-delimiters-depth-2-face
     ((,class (:inherit rainbow-delimiters-base-face :foreground ,blue-2))))

   `(rainbow-delimiters-depth-3-face
     ((,class (:inherit rainbow-delimiters-base-face :foreground ,green-01))))

   `(rainbow-delimiters-depth-4-face
     ((,class (:inherit rainbow-delimiters-base-face :foreground ,cyan-3))))

   `(rainbow-delimiters-depth-5-face
     ((,class (:inherit rainbow-delimiters-base-face :foreground ,white-0))))

   `(rainbow-delimiters-depth-6-face
     ((,class (:inherit rainbow-delimiters-base-face :foreground ,black-2-5))))

   `(rainbow-delimiters-depth-7-face
     ((,class (:inherit rainbow-delimiters-base-face :foreground ,magenta-3))))
   ...
   ;; `(helm-header ((,class (:foreground ,magenta-3 :background ,black-6))))
   ...
   ;; `(helm-selection ((,class (:foreground ,red-00 :background nil, :underline t))))
   ...
   ;; diff-hl
   `(diff-hl-change ((,class (:background "#333355" :foreground "deep sky blue"))))
   ...
   `(dired-header ((,class (:foreground ,green-02 :background nil :weight normal))))
   ...
   `(dired-filter-group-header ((,class (:foreground ,red-00 :background nil))))
   ...
   `(smerge-refined-added ((t (:inherit smerge-refined-change :background ,green-4))))
   `(smerge-refined-removed ((t (:inherit smerge-refined-change :background ,red-4))))
   `(smerge-lower ((t (:background ,green-5))))
   ...
   `(flymake-error ((,class (:background "PaleVioletRed4" :foreground "white" :underline nil))))
   ;; Flycheck
   ;; `(flycheck-error ((,class (:background ,red-4 :foreground ,white-0 ))))
   `(flycheck-error ((,class (:underline ,orange-2))))
   `(flycheck-warnline ((,class (:background ,orange-2 :foreground ,white-0 ))))

   ;; Javascript
   `(js2-function-param-face ((,class (:foreground ,green-02))))
   `(js2-function-param ((,class (:foreground ,green-02))))
   ...
   `(compilation-error ((,class (:foreground ,black-6 :background ,magenta-0 ))))
   ...
   `(web-mode-comment-keyword-face ((,class (:box 1  :weight semi-light))))
   ...
   `(web-mode-html-tag-face ((,class (:foreground ,pouria))))

   ;; bm
   `(bm-face ((,class (:foreground "gray" :background "gray16"))))

   ;; ido
   `(ido-first-match ((,class (:weight normal :foreground ,blue-01))))
   `(ido-only-match ((,class (:weight normal :foreground ,blue-1))))
   ;; Custom
   ...
   `(variable-pitch ((,class (:weight bold :family "quicksand"))))
